...
const [, , outputPath = "data/source/lima-traffic-overpass.json"] = process.argv;
const bbox = "(40.6876590,-84.1650988,40.7956561,-84.0708798)";
const query = `[out:json][timeout:240];
way
  ["highway"~"^(motorway|trunk|primary|secondary|tertiary|residential|living_street|unclassified|service)$"]
  ["area"!="yes"]
